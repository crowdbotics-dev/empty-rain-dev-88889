"""
Django settings for empty_rain_dev_88889 project.
...
ROOT_URLCONF = 'empty_rain_dev_88889.urls'
...
WSGI_APPLICATION = 'empty_rain_dev_88889.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "empty_rain_dev_88889 API",
    "DESCRIPTION": "API documentation for empty_rain_dev_88889 App",
    "VERSION": "v1",
}
